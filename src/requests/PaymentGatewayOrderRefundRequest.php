 ...
 */
class PaymentGatewayOrderRefundRequest implements PaymentGatewayRequestInterface
{
    use RequestSettings;
    ...
    public function execute()
    {
        ...
        return new PaymentGatewayOrderRefundRequestResult($httpClient->execute());
    }

    final private function getRequestBody()
    {
        $templateFile = __DIR__ . '/templates/RefundOrderRequestBodyTemplate.xml';
